...
# X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=.3)#按比例切分训练和测试集
#
...
train_writer = tf.summary.FileWriter('logs/trai', sess.graph)##########
test_writer = tf.summary.FileWriter('logs/tes', sess.graph)#########
init = tf.global_variables_initializer()
sess.run(init)
